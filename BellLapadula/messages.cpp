 ...
 ***********************************************/
void Messages::display(Control subject) const
{
   for (list <Message> :: const_iterator it = messages.begin();
        it != messages.end();
        ++it)
      it->displayProperties(subject);
}
 ...
 **********************************************/
void Messages::show(Control subject, int id) const
{
   for (list <Message> :: const_iterator it = messages.begin();
        it != messages.end();
        ++it)
 ...
 ***********************************************/
void Messages::update(Control subject, int id, const string & text)
{
 ...
 **********************************************/
void Messages::remove(Control subject, int id)
{
   for (list <Message> :: iterator it = messages.begin();
        it != messages.end();
        ++it)
...
void Messages::add(const string & text,
                   ...
                   const string & date)
{
   Message message(text, author, date, "Public");
